...
export class SalesHomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      if (
        ...
        this.sellingService.soldBook(this.new_payment).subscribe(
          (response) => {
    ...
    this.sellingService.getAllPosts().subscribe(
      (response) => {
    ...
    this.spinner.show();
    this.sellingService.getMyPosts().subscribe(
      (response) => {
  ...
  onsubmit(Values: any) {
    ...
    this.sellingService.createPost(newpost).subscribe(
      (response) => {
